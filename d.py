...
def add_planet2(img):# функція додає противників в список через створення обєкту
    y =19
    for el in range(5):
       ufo = main(random.randint(10,W-30),y,70,70,img)
       planet2_list.append(ufo)# створення обєкту противника та додавання в список



add_planet('planet.png')
add_planet2('planet2.png')
...
#--------------------астероїди------------------------
    ...
    if score_number>=10 and score_number<=15:
        level_planet = True
    if score_number >= 16 and score_number <= 20:
        level_planet2 = True
